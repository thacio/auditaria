...
which projects can use the full capabilities of Auditaria CLI. It prevents
...
Once the feature is enabled, the first time you run Auditaria CLI from a folder,
...
When a folder is **untrusted**, Auditaria CLI runs in a restricted "safe mode"
...
Granting trust to a folder unlocks the full functionality of Auditaria CLI for
that workspace.
