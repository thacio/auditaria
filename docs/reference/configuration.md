...
**Note for Enterprise Users:** For guidance on deploying and managing Auditaria
...
Auditaria CLI's responses to your specific needs and projects.

## Sandboxing

Auditaria CLI can execute potentially unsafe operations (like shell commands and
