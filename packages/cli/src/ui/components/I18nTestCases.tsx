  ...
  return (
    <Box flexDirection="column">
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <Text>
        {count === 0 ? '4.' : '3.'} <Text bold>/help</Text> for more
        information.
      </Text>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <Text>
        {isActive ? 'Active' : 'Inactive'} user with{' '}
        {hasFeature ? 'premium' : 'basic'} plan
      </Text>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <Text>{isActive ? <Text bold>✓</Text> : '✗'} Status indicator</Text>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <Text>
        Press <Text bold>Enter</Text> to confirm or <Text dimColor>Esc</Text> to
        cancel
      </Text>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      {isActive && <Text>This only shows when active</Text>}
