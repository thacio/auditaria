...
- **Contextual Precedence:** Instructions found in ${formattedFilenames} or \`AUDITARIA.md\` files are foundational mandates. They take absolute precedence over the general workflows and tool defaults described in this system prompt.
...
${renderLanguageInstructions(options.language)}
`.trim();
}
...
export function renderUserMemory(
  ...
  if (typeof memory === 'string') {
    ...
    return `
# Contextual Instructions (${formattedHeader} / AUDITARIA.md)
