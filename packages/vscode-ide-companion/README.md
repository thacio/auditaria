...
The Auditaria Companion extension pairs with
[Auditaria](https://github.com/thacio/auditaria.git). This extension is
compatible with both VS Code and VS Code forks.

# Features

- Open Editor File Context: Auditaria gains awareness of the files you have open
  in your editor, providing it with a richer understanding of your project's
  structure and content.

- Selection Context: Auditaria can easily access your cursor's position and
