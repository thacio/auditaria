...
function getEmbeddedWasmAsset(specifier: string): Uint8Array | null {
  /* eslint-disable @typescript-eslint/no-unsafe-type-assertion -- AUDITARIA: accessing runtime-injected embedded assets */
...
export const DEFAULT_MAX_LINES_TEXT_FILE = 6000; // AUDITARIA_CHANGE: increased from upstream's 2000
const MAX_LINE_LENGTH_TEXT_FILE = 30000; // AUDITARIA_CHANGE: increased from upstream's 2000
