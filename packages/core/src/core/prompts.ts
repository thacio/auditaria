...
3. **Implement:** Use the available tools (e.g., '${EditTool.Name}', '${WRITE_FILE_TOOL_NAME}', '${ShellTool.Name}' ...) to execute audit procedures, strictly adhering to the project's established conventions (detailed under 'Core Mandates'). Collect sufficient, reliable, relevant, and useful audit evidence.
