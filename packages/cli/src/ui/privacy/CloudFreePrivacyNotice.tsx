...
export const CloudFreePrivacyNotice = ({
  ...
  if (privacyState.isLoading) {
    return <Text color={theme.text.secondary}>{t('privacy.loading', 'Loading...')}</Text>;
  }
  ...
  return (
    <Box flexDirection="column" marginY={1}>
      ...
      <Text color={theme.text.primary}>
        ...
        <Text color={theme.text.link}>[1]</Text> {t('privacy.notice_intro_cont', 'describe how Gemini Code Assist handles your data. Please read them carefully.')}
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
      ...
      <Text color={theme.text.secondary}>
        {t('privacy.press_enter_choose_exit', 'Press Enter to choose an option and exit.')}
      </Text>
    </Box>
  );
};
